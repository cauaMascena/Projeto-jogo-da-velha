...
const casas = document.getElementsByTagName('plano1'); //pega a lista de casas do tabuleiro do jogo
...
// vencedor = '_'; //Define se há um vencedor ou não (_ = indefinido; X = jogador X, O = jogador O)
// finish;
